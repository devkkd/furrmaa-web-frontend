...
import { adminGetVeterinarians, adminDeleteVeterinarian, adminCreateVeterinarian, adminUploadImage } from '@/lib/api';
    ...
    <div className="space-y-6">
      ...
      {showForm && (
        <div className="bg-white border border-gray-100 rounded-xl p-6 max-w-xl">
          <h2 className="text-lg font-bold text-gray-900 mb-4">Add Veterinarian</h2>
          <form onSubmit={handleAdd} className="space-y-4">
            ...
            <button type="submit" disabled={saving} className="bg-[#1F2E46] text-white font-medium px-5 py-2.5 rounded-lg disabled:opacity-70">{saving ? 'Saving…' : 'Add Veterinarian'}</button>
          </form>
        </div>
      )}
